...
| MVP route/API contract | [`mvp/route-map.md`](mvp/route-map.md) | ACTIVE_SUPPORTING | executable API/routes reconciled by #132 | contributor; AI agent; operator/release | repository maintainer | route, payload, auth or repository contract | 2026-10-16 |
