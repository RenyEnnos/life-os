...
async def run_test():
    ...
    try:
        ...
        # -> Try logging in again by clicking the 'ENTRAR' submit button, then wait for the dashboard to load and re-evaluate interactive elements to proceed to the habits UI test.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div/div[2]/div[2]/div/div[2]/form/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
