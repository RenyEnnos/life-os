...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and submit the login form to navigate to the dashboard.
        ...
        # -> Click the 'Pular e ir direto para o app' button to skip setup and load the dashboard (element index 1293).
        frame = context.pages[-1]
        # Click element
