...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and click the ENTRAR button.
        ...
        # -> Check the page for dashboard-specific indicators (e.g., 'Nexus', 'Saldo Líquido', 'Usuário', avatar) to confirm login, then refresh the app and re-check the same indicators to confirm session persistence.
        await page.goto("http://localhost:5173/", wait_until="commit", timeout=10000)
