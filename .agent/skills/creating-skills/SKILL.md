...
description: Generates high-quality, predictable, and efficient `.agent/skills/` directories based on user requirements. Use when the user asks to create, build, or scaffold a new skill.
---
