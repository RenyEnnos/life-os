...
{/* Sidebar Navigation */}
<aside className="w-64 sidebar-glass flex flex-col p-6 shrink-0">
<div className="flex items-center gap-3 mb-10 px-2">
<div className="h-10 w-10 rounded-lg bg-primary flex items-center justify-center">
<span className="material-symbols-outlined text-white">orbit</span>
</div>
<div>
<h1 className="text-white text-lg font-bold leading-none">LifeOS</h1>
<p className="text-white/40 text-xs mt-1">Vitals Pro</p>
</div>
</div>
<nav className="flex-1 space-y-2">
<div className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/50 hover:bg-white/5 transition-colors cursor-pointer">
<span className="material-symbols-outlined">dashboard</span>
<span className="text-sm font-medium">Dashboard</span>
</div>
<div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-primary/10 text-primary transition-colors cursor-pointer">
...
<button className="w-full bg-primary hover:bg-primary/90 text-white rounded-lg py-3 flex items-center justify-center gap-2 font-bold text-sm transition-all shadow-lg shadow-primary/20">
