...
export const StatusCard = () => {
    ...
    return (
        <BentoCard
            className="md:col-span-2 cursor-pointer p-0"
            noPadding
        >
            <MagicCard onClick={() => navigate('/habits')} className="items-center justify-center p-6 h-full bg-[#111] w-full" gradientColor="#222">
...
export const StatsCard = () => {
    ...
    return (
        <BentoCard
            className="md:col-span-1 cursor-pointer p-0"
            noPadding
        >
            <MagicCard onClick={() => navigate('/tasks')} className="items-center justify-center p-6 h-full bg-[#111] w-full" gradientColor="#222">
...
export const ChartCard = () => {
    return (
        <BentoCard
            className="md:col-span-3 bg-[#111] border-white/5 p-0"
            noPadding
        >
            <NeonChart
