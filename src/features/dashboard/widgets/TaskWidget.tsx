                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 flex flex-col gap-2">
                    ...
                    {agenda.map(task => (
                        <div key={task.id} className="group flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-all">
                            ...
                            {!task.completed && (
                                <button
                                    className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary p-2 rounded-full bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 transition-all"
                                    title="Iniciar Foco"
