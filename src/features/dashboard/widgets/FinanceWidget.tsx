            ...
            {isAdding ? (
                <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
                    ...
                    <button
                        ...
                        className="mt-2 bg-white text-black font-medium py-2 rounded-lg text-sm hover:bg-zinc-200 disabled:opacity-50 transition-colors w-full flex justify-center"
                    >
