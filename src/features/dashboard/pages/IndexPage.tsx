...
{/* Sidebar */}
<aside className="glass-sidebar w-72 flex flex-col p-6 shrink-0">
<div className="flex items-center gap-4 mb-10">
<div className="size-10 rounded-lg bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center">
<span className="material-symbols-outlined text-white">keyboard_command_key</span>
</div>
<div>
<h1 className="text-lg font-bold tracking-tight">LifeOS</h1>
<p className="text-xs text-white/40 uppercase tracking-widest font-semibold">Command Center</p>
</div>
</div>
<nav className="flex flex-col gap-2 flex-1">
<a className="flex items-center gap-3 px-4 py-3 rounded-lg bg-primary text-white shadow-lg shadow-primary/20 transition-all" href="#">
<span className="material-symbols-outlined fill-1">dashboard</span>
<span className="font-medium">Dashboard</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-lg text-white/50 hover:bg-white/5 hover:text-white transition-all" href="#">
...
<img alt="User Profile" className="size-10 rounded-full object-cover ring-2 ring-primary/20" data-alt="Portrait of a young man smiling" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1VYI5Byqh9Ttk9gZo4Dw0e6_oIjPLQv0VFykC7j99j1cPW3e7NEpuMHaSHfQIc9KmM4QjZfXEUzpXF2XrITiREUgDGDjRHSHbe5xYO9qLgDOIwW1wUfzuLNDuVvE6FKmgt8lgn469BYi-Vn-OMD-UPBCdIxb_fW77MQB4tzhaaj3UIAK9IIPd9P8KM4cQLj6Yr35u73tFGZ7nv2qYteYEF-rUK5H_zJQsBOWMaOtqI1Y1ocozZSHNblUPGJdWXJV7gmz89f9Pg3U"/>
<div>
<p className="text-sm font-bold">Pedro Duarte</p>
<p className="text-[10px] text-white/40 uppercase tracking-tighter">Pro Member</p>
</div>
</div>
<button className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-white/5 hover:bg-white/10 text-white/70 transition-all">
