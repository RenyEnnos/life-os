    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
                <label htmlFor={`${uniqueId}-title`} className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Título</label>
                <Input
                    id={`${uniqueId}-title`}
                    type="text"
                    required
            ...
            <div className="space-y-2">
                <label htmlFor={`${uniqueId}-description`} className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Descrição (Opcional)</label>
                <textarea
            ...
            <div className="space-y-2">
                <label htmlFor={`${uniqueId}-due-date`} className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Data de Vencimento</label>
                <Input
                    id={`${uniqueId}-due-date`}
                    type="date"
                    value={dueDate}
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    <label htmlFor={`${uniqueId}-energy-level`} className="text-sm font-mono text-muted-foreground uppercase tracking-wider">
                        Energia
                    </label>
                    <select
                        id={`${uniqueId}-energy-level`}
                        value={energyLevel}
                ...
                <div className="space-y-2">
                    <label htmlFor={`${uniqueId}-time-block`} className="text-sm font-mono text-muted-foreground uppercase tracking-wider">
                        Período
                    </label>
                    <select
                        id={`${uniqueId}-time-block`}
                        value={timeBlock}
            ...
            <div className="space-y-2">
                <div className="flex justify-between items-end">
                    <label htmlFor={`${uniqueId}-new-tag`} className="text-sm font-mono text-muted-foreground">Tags</label>
                    <Button
                        type="button"
                        variant="ghost"
                        size="sm"
