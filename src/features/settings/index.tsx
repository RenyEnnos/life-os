...
type SettingsSection = 'account' | 'general' | 'accessibility' | 'appearance' | 'integrations' | 'data';
                ...
                <main className="flex-1 flex flex-col lg:flex-row h-full overflow-hidden bg-background-dark/80">
                    <div className="w-full lg:w-64 flex flex-col border-b lg:border-b-0 lg:border-r border-white/5 bg-zinc-900/10 backdrop-blur-md z-20">
                        ...
                        <nav className="hidden lg:flex flex-col gap-1 p-4 mt-2">
                            ...
                            <button
                                onClick={() => handleSectionChange('general')}
                                className={`group relative flex items-center gap-3 w-full px-3 py-2 text-sm rounded-lg transition-all ${
                                    activeSection === 'general'
                            ...
                            >
                                {activeSection === 'account' && <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-4 bg-primary rounded-r-full" />}
                                <span className={`material-symbols-outlined text-[18px] ${activeSection === 'account' ? 'text-primary' : ''}`}>person</span>
                                Account
                            </button>
                            <button
                                onClick={() => handleSectionChange('accessibility')}
                    ...
                    <div className="flex-1 h-full overflow-y-auto p-4 lg:p-10 relative">
                        ...
                        <div className="max-w-5xl mx-auto w-full pb-24 space-y-10 animate-[fadeIn_0.4s_ease-out_forwards]">
                            ...
                            {activeSection !== 'account' && activeSection !== 'accessibility' && (
                                <section className="flex flex-col items-center justify-center gap-4 py-20">
                                    <span className="material-symbols-outlined text-6xl text-zinc-700">construction</span>
                                    <h2 className="text-xl font-semibold text-white">Coming Soon</h2>
                                    <p className="text-sm text-zinc-500">The {activeSection} settings are under development.</p>
                                </section>
                            )}
                        </div>
                    </div>
